  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex gap-3">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all pr-12 bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
            />
            {isSearching && (
          ...
          <div className="mt-6 space-y-3">
            ...
            <div className="space-y-2 max-h-80 overflow-y-auto">
              {searchResults.map((result, index) => (
                <div
                  key={index}
                  className="flex items-center gap-4 p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 hover:border-purple-200 hover:shadow-md transition-all"
                >
                  {result.imageUrl ? (
                    <img
                      src={result.imageUrl}
                    ...
                    <div className="w-16 h-10 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-700 dark:to-slate-600 rounded flex items-center justify-center">
      ...
      <div className="flex items-start gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
        <svg className="w-5 h-5 text-slate-400 dark:text-slate-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
